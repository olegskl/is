/**
 * @license MIT license.
 *    Portions of is.g.js are inspired or borrowed from Underscore,
...
(function (root) {
    ...
    root.isBoolean = function (variable) {
        ...
        // is.g.js rejects booleans created in this way because they are not
     ...
     *
     * @example isObject(function () {}); // true
